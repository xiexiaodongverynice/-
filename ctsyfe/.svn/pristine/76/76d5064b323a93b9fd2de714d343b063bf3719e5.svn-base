                ...
                return {
                    ...
                    link: function (scope, elm, attrs) {
                        ...
                        var options = {
                            ...
                            yearStart: (attrs.yearstart && parseInt(attrs.yearstart)) || dateTimeNow.getFullYear() ,//开始年份
                            yearEnd: (attrs.yearend && parseInt(attrs.yearend)) || dateTimeNow.getFullYear() + 4,  //结束年份
                            monthStart: 12,//开始月份
                            monthEnd: 1,//结束月份
                        ...
                        scope.ok = function () {
                            ...
                            hide();
                            if (scope.okHandler) {
                                var aa = scope.okHandler({result: datetime});
                                console.log(aa);
                            }
                        }
